...
int op_exec_count(struct trail_ctx*, int, uint64_t, const uint32_t*, uint32_t, const void*);
...
int op_exec_limit(struct trail_ctx*, int, uint64_t, const uint32_t*, uint32_t, const void*);
